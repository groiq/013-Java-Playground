...
//		System.out.println("one-liner: calculateTaxes(" + gross + ")");
	 ...
	 * Throws IllegalArgumentException if the array doesn't have exactly three elements.
...
//		System.out.println("asString(int[])");
		...
		if (stats.length == 3) {
			...
			throw new IllegalArgumentException("int[] stats must be three elements long (gross value, tax and net value).");
		}
